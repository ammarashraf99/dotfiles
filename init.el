...
(add-hook 'better-jumper-mode-hook #'my/clean-modeline)

;; don't write the branch name on mode line
...
;; flatland gruber-darker gruvbox-dark-medium  subdued  twilight
...
(setq ispell-dictionary "en")  ;; en for English
...
(use-package vterm
  ...
  (vterm--set-directory "/home/ammarashraf")
  (setq default-directory "/home/ammarashraf")
...
(setq ccls-args '("--log-file=/dev/null"))
...
(use-package org
  ...
  (setq org-agenda-files
	'(
	  "/home/ammarashraf/TODOs/Periodics.org"
	  "/home/ammarashraf/TODOs/Today.org"
	  "/home/ammarashraf/TODOs/Week.org"
	  ))
...
(setq org-capture-templates
   `(
     ("r" "Random...")
     ("rr" "Random" entry (file+olp "/home/ammarashraf/TODOs/Random.org" "Random Moments !!")
      "* TODO %?\n  %U\n  %a\n  %i" :empty-lines 1)
     ))
